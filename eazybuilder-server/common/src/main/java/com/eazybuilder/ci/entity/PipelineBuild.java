...
public class PipelineBuild {
	...
	//上线的时候用这个字段传提测时生成的镜像版本
	private String releaseDockerImage;
	...
	public String getReleaseDockerImage() {
		return releaseDockerImage;
	}

	public void setReleaseDockerImage(String releaseDockerImage) {
		this.releaseDockerImage = releaseDockerImage;
	}
