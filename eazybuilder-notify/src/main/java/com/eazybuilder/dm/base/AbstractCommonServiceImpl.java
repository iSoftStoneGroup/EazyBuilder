...
import com.eazybuilder.dm.dao.BaseDao;
...
public abstract class AbstractCommonServiceImpl<E extends BaseDao<T,String>,T> implements CommonService<T>{
	...
	/**
	 * 从{@link com.eazybuilder.dm.base.PageSearch}
	 * 中获取Q类以及需要查询属性名，创建like语句的predicate，多个以or语句组合
	 *
	 * @param search
	 * @return 该实现类未标记{@link com.eazybuilder.dtg.ci.base.PageSearch}或者fileds为空时返回null
	 * @throws Exception
	 */
