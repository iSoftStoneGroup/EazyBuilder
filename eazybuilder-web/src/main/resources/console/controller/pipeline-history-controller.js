app.controller('pipelineHistoryController', function($scope,$http,$window,$state,$filter,$modal,$interval,$alert,basicService) {
	$scope.condition={};
						...
						$http.get(backend.url+"/api/pipeline/buildStatus?projectId="+row.id).then(function(response){
							...
							if(response.data&&response.data!='null'){
								if(response.data.buildStatus=='IN_PROGRESS'){
									//var buildUrl="http://jenkinsxxxxx/jenkins/job/"+row.jobName+"/";
