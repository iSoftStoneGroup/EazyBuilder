...
(function(mod) {
   ...
   * @param newData
   * @param oldData
   * @param isShow_revertButtons
   * @returns {CodeMirror.MergeView|undefined}
   */
  CodeMirror.k_init=function(id,newData,oldData,isShow_revertButtons){
    ...
    function initUI() {
      ...
      var dv = CodeMirror.MergeView(target, {
        ...
        revertButtons:isShow_revertButtons,//事件比较替换
      });
      return dv;
    }
  };
