...
const guardTypes = {new_unit_test_coverage_rate:'新增代码单元测试覆盖率',unit_test_success_rate:'单元测试通过率',unit_test_coverage_rate:'单元测试覆盖率',bug_blocker:'BUG(阻断)',
	vulner_blocker:'安全漏洞(阻断)',
	code_smell_blocker:'编码规范(阻断)'
};


const actionScopes = {CODE_PUSH:'门禁设置',SONARQUBE_RULE:'sonar规则集'};

const actionScopeGuardTypes = {
	CODE_PUSH: ['unit_test_success_rate','unit_test_coverage_rate','new_unit_test_coverage_rate','bug_blocker','vulner_blocker','code_smell_blocker'],
