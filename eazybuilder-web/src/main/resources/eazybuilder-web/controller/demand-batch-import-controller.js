app.controller('demandBatchImportController', function($scope,$http,$window,$state,$filter,$modal,basicService) {
	$scope.condition={};
	...
	$scope.save=function(){
		...
		$http.post(backend.url+"/api/demandBatchImport",$scope.entity.projects)
				.then(function(response){
			var modalInstance=$modal({
				  title: '批量导入结果', 
				  templateUrl: 'app/demand/import-result.html', 
			      show: true,
